...
| 层 | 脚本 | 验什么 | 依赖 |
| --- | --- | --- | --- |
| 构建 | build.ps1 + check-branding.ps1 | MSBuild Debug 编译零 error，产出 bin/Debug/CommandCenter.exe；check-branding 品牌检查（V2.16.5：app.ico 七层齐全 + csproj ApplicationIcon 接线 + exe 产品名 IrisVision/中文说明 + 内嵌图标可提取） | MSBuild |
