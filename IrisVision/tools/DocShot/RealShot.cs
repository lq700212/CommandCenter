...
//   /out:IrisVision\bin\Debug\cc_realshot.exe
//   /r:System.dll /r:System.Drawing.dll /r:System.Windows.Forms.dll
//   IrisVision\tools\DocShot\RealShot.cs
// 运行（workdir=IrisVision\bin\Debug）：
...
public static class RealShot
{
    ...
    public static int Main(string[] args)
    {
        ...
        foreach (var ex in Process.GetProcessesByName("IrisVision"))
        {
            Log("[REALSHOT-ABORT] another IrisVision process alive, pid=" + ex.Id + " (close it first)");
            return 3;
        }

        var exe = Path.Combine(Environment.CurrentDirectory, "IrisVision.exe");
