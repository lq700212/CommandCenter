...
```powershell
# 编译（仓库根）与运行（workdir=IrisVision\bin\Debug）见 RealShot.cs 头部注释
.\cc_realshot.exe E:\Project\IrisVision\docs\images
```
...
& "D:\Program Files\Microsoft Visual Studio\18\Enterprise\MSBuild\Current\Bin\Roslyn\csc.exe" `
  ...
  /out:IrisVision\bin\Debug\cc_docshot.exe `
  /r:IrisVision\bin\Debug\IrisVision.exe `
  /r:IrisVision\bin\Debug\Newtonsoft.Json.dll `
  /r:System.dll /r:System.Core.dll /r:System.Drawing.dll /r:System.Windows.Forms.dll `
  IrisVision\tools\DocShot\DocShot.cs
```

注意：源码含中文，csc 必须加 `/codepage:65001`，否则中文注释乱码编译失败。

## 运行（工作目录必须是 `IrisVision\bin\Debug`）

```powershell
.\cc_docshot.exe E:\Project\IrisVision\docs\images
```
